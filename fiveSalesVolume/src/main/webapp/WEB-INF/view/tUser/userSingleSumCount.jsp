					...
					<tbody id="dataTbody">
						<c:forEach items="${commonInfoList}" var="commonInfoList" varStatus="i">
							<tr>
								...
								<td align="center"><input type="button" id="delBtn" name="${commonInfoList.value.id}" onclick='del(this.name);' value="删除"/></td>
							</tr>
						</c:forEach>
						<%-- <tr>
							<td colspan="9">
...
function exportExcel(){
	...
	var beginDate = $("#beginDate").val();
	var endDate = $("#endDate").val();
	window.location.href="${ctx}/tUser/exportPartakeData?flag=3&beginDate="+beginDate+"&endDate="+endDate;
}
