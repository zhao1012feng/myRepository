...
<div class="mainBox"
	...
	<h3>
		<a href="javaScript:;" class="actionBtn" onclick="exportExcel()">导出全部数据（Excel）</a>员工件数信息
	</h3>
			...
			<table width="100%" border="0" cellpadding="8" cellspacing="0"
				class="tableBasic">
					...
					<tr>
						...
						<th width="20" align="center">金鸡贺岁2017鸡年生肖贺岁邮品金大全套</th>
						<th width="20" align="center">金鸡贺岁2017鸡年生肖贺岁邮品金四方连1.3克</th>
						...
						<th width="20" align="center">2017PCGS熊猫银币套装(5枚单套)</th>
						<th width="20" align="center">2017PCGS熊猫银币套装(小箱装)</th>
						<th width="20" align="center">2017PCGS熊猫银币套装(大箱装)</th>
						<th width="20" align="center">心经金环</th>
						<th width="20" align="center">其他产品</th>
					...
					<tbody id="dataTbody">
						<c:forEach items="${commonInfoList}" var="commonInfoList" varStatus="i">
							<tr>
								...
								<td align="center">${commonInfoList.value.xx}</td>
								<td align="center">${commonInfoList.value.yy}</td>
								<td align="center">${commonInfoList.value.zz}</td>
...
function exportExcel(){
	...
	var beginDate = $("#beginDate").val();
	var endDate = $("#endDate").val();
	window.location.href="${ctx}/tUser/exportPartakeData?flag=1&beginDate="+beginDate+"&endDate="+endDate;
}
