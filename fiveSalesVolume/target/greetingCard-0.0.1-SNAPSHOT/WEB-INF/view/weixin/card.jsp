...
<link rel="stylesheet" href="${ctx}/static/weixin/css/css.css?s=1" />
...
<body>
	...
	<div class="swiper-container">
		<div class="swiper-wrapper">
			<div class="swiper-slide box1">
				...
				<div class="ani box1_test1" data-slide-in="at 800 from fadeIn use swing during 1000">
				<span class="name1 hehe_2">小明小明小明小明小明</span>
				</div>
				<div class="ani box1_test111" data-slide-in="at 800 from fadeIn use swing during 1000"><img src="${ctx}/static/weixin/img/chou3.png" /></div>
				<div class="ani box1_test11" data-slide-in="at 800 from fadeIn use swing during 1000"><span class="name">是明小明小明小明小明</span></div>
				<div class="ani box1_test2" data-slide-in="at 800 from fadeIn use swing during 1000"></div>
			...
			<div class="swiper-slide box2">
				...
				<div class="box2_test">
					...
					<p class="ani"
						...
						<span class="name">小明小明小明小明小明</span>
					</p>
			...
			<!-- <div class="swiper-slide box5">
				<div class="ani box5_c1_b1"
					data-slide-in="at 500 from fadeInLeft use swing during 500"></div>
				<div class="ani box5_c1_b2"
					data-slide-in="at 500 from fadeInRight use swing during 500"
					></div>
					<button class="ani aaa" >我也要送祝福</button>
				<div class="ani box5_c1_b4"
					data-slide-in="at 1000 from fadeIn use swing during 500"
					></div>
			</div> -->
			...
			<div class="swiper-slide box4">
				...
				<div class="box4_test">
					<p class="ani"
						data-slide-in="at 0 from zoomInUp use swing during 2500">收卡人</p><input class="ani"
					data-slide-in="at 300 from zoomInUp use swing during 2500"
					value="" id="userName" type="text" placeholder="请输入姓名" maxlength="10">
						
					
					<p class="ani"
					data-slide-in="at 0 from zoomInUp use swing during 2500">发卡人</p><input class="ani"
					data-slide-in="at 300 from zoomInUp use swing during 2500"
					value=""  placeholder="请输入姓名" id="userName1" type="text" maxlength="10">
	...
	<script type="text/javascript" src="${ctx}/static/weixin/css/swiper.animate1.0.2.min.js"></script>
	<script src="${ctx}/static/weixin/js/swiper.animate-twice.min.js"></script> 
	
	<%-- 
	<script src="${ctx}/static/swiper3/lib/swiper-3.3.1.min.js"></script>
    <script src="${ctx}/static/swiper3/lib/3dflow/idangerous.swiper.3dflow.js" type="text/javascript" charset="utf-8"></script>
	<script src="${ctx}/static/weixin/js/swiper.animate-twice.min.js"></script> --%>
					...
					ajax({
			    		...
			    		success:function(data){
			    			if(data.state==true){
			    				...
			    				$(".name").html(info.producer);
			    				$(".name1").html(info.recipient);
