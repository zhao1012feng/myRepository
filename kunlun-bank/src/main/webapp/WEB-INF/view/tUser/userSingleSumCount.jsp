	...
	<form name="action" method="post" action="article.php?rec=action">
		<table width="100%" border="0" cellpadding="8" cellspacing="0"
			...
			<tr>
				...
				<th width="30" align="center">普通产品总件数</th>
				<th width="30" align="center">普通产品总销量</th>
				<th width="30" align="center">心经金环总件数</th>
				<th width="30" align="center">心经金环总销量</th>
				<th width="30" align="center">其他产品总件数</th>
				<th width="30" align="center">其他产品总销量</th>
			...
			<tbody id="dataTbody">
				...
				<c:forEach items="${commonInfoList}" var="commonInfoList"
					...
					<tr>
						...
						<td align="center"><input type="button" id="delBtn"
							name="${commonInfoList.value.serial_num}"
							onclick='del(this.name);' value="删除" /></td>
					</tr>
				</c:forEach>
				<%-- <tr>
							<td colspan="9">
...
function exportExcel(){
	...
	window.location.href="${ctx}/tUser/exportPartakeData?flag=3&beginDate="+beginDate+"&endDate="+endDate+"&bank="+bank+"&orgName="+orgName;
}
